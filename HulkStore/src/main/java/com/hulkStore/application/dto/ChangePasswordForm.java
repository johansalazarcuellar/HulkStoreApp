package com.hulkStore.application.dto;
...
public class ChangePasswordForm {
	...
	@NotBlank(message="Contrasena actual no puede estar vacio")
	private String currentPassword;
	
	@NotBlank(message="Nueva Contrasena no pueda estar vacio")
	private String newPassword;
	
	@NotBlank(message="Confirmar contrasena no puede estar vacio")
